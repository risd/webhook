...
var gitBranch = require('./util').gitBranch;
...
module.exports = function (options) {
  ...
  var series = [ ensureSiteNameAndToken ]

  if ( config.skipBuild === false ) series = series.concat( [ runBuild ] )

  series = series.concat([ runAssetBuild, createZip, uploadZip ])

  async.series( series , onComplete);

  function ensureSiteNameAndToken (step) {
