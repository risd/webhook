...
var defaultContinuationUrlFn = require( './auth-continuation-url.js' )
...
function FirebaseInterface ( options ) {
  ...
  this.authContinuationUrlFn = options.firebaseAuthContinuationUrlFn || defaultContinuationUrlFn;
}
...
FirebaseInterface.prototype.allSites = WebhookSites;
FirebaseInterface.prototype.removeSiteKeyData = WebhookSiteKeyDataRemove;
FirebaseInterface.prototype.allUsers = WebhookUsers;
FirebaseInterface.prototype.resetUserPassword = WebhookUserPasswordReset;
...
function WebhookUserPasswordReset ( options ) {
  ...
  var continuationUrl = this.authContinuationUrlFn( options )

  return firebase.auth().sendPasswordResetEmail( userEmail, { url: continuationUrl } )
}
