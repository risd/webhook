...
module.exports = function ( options, callback ) {
  ...
  var series = [
    ensureSiteNameAndKeyExist( config ), // adds { sitename, sitekey }
    authenticateFirebaseInstance( { config: config, firebase: firebaseRoot } ), // adds { webhookUsername, webhookPassword }
    pushDomainMapTask,
  ];
