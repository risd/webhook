...
module.exports = function (options) {
  ...
  var config = {
    baseGit: options.generate || 'http://dump.webhook.com/static/generate-repo.zip',
    ...
    imgix_host: options.imgix_host || '',
    imgix_secret: options.imgix_secret || '',
  };
...
function downloadRepo(config, tmpFolder, callback) {
  ...
  var repoRequest = request(config.baseGit);
