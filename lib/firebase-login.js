...
module.exports.tokenAuth = function ( token, callback ) {
	var firebaseRoot = new Firebase( 'https://' + firebaseName + '.firebaseio.com' )
	firebaseRoot.auth( firebaseSecret, function ( error ) {
		if ( error ) return callback( error )
		else return callback( null, firebaseRoot )
	} )
}
